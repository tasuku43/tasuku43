...
その後は、TypeScriptおよびReact／Next.jsを用いたフロントエンド開発にも携わり、設計からデプロイまで一貫した開発フローを習得。また、フルサイクル開発者として、AWS（CloudFront、API Gateway、CloudWatch、IAMなど）を活用したインフラ運用や、Datadogを用いた監視体制の構築も経験しています。

現在はSREグループに所属し、Helmfile・Helm・ArgoCDを用いたEKS基盤の運用を担うとともに、CI/CDパイプラインの改善など、開発生産性の向上にも取り組んでいます。

今後は、基盤技術やクラウドネイティブ技術への理解をさらに深めながら、バリューストリーム全体を俯瞰し、改善活動が自律的に循環する文化を育むエンジニアを目指しています。技術的貢献にとどまらず、組織全体の継続的な成長にも寄与していきたいと考えています。
<br>
...
私は中長期的に、**バリューストリーム全体を俯瞰し、技術と仕組みの両面から継続的な改善を推進できるエンジニア**を目指しています。開発チームが自律的に課題を特定・解決できる環境や文化づくりに携わり、技術とチームの成長を両立させていきたいと考えています。

これまでバックエンド／フロントエンド／インフラと幅広く経験を積む中で、**EKS や CI/CD 基盤、Terraform／ArgoCD などのクラウドネイティブ技術の実運用や改善に携わる機会**が増えてきました。そうした経験を通じて、**技術的な課題を自ら発見し、提案から実施まで一貫して取り組む力を少しずつ身につけてきています**。現在は、SREグループの一員として、主に技術基盤や運用改善の観点から開発チームを支援しており、プロセスや仕組みの改善に技術面から関与する機会が増えています。


こうした背景を踏まえ、以下の戦略を軸に成長を図っています：
